...
{   //declarei vetores de caracteres para receber nomes(alguns já atribuí valores),variáveis inteiras, variaveis de numeros com virgula usando float e mais abaixo uma constante
    ...
    fgets (r1.nome_do_cliente,50,stdin); //Inicializo coletando as informaçoes do usuario e coloco nas devidas variáveis

    printf("\n\n\nDigite o seu sobrenome para cadastramento: \n\n\n");
    fgets(r1.sobrenome_do_cliente,50,stdin);

    printf("\n\n\nDigite sua data de nascimento para cadastramento usando '/' exemplo-->xx/xx/xxxx: \n\n\n");
    fgets(r1.data_de_nascimento,50,stdin);

    printf("\n\n\nDigite o seu numero de contato para cadastramento: \n\n\n");
    fgets(r1.telefone_do_cliente,50,stdin);

    printf("\n\n\nDigite sua idade: \n\n\n");
    scanf("%d", &r1.idade_do_cliente);
    printf("\n\nDigite por favor a quantidade de convidados previstos para o evento: \n\n");
    printf("\n\n\n A quantidade maxima de convidados eh de 500 pessoas e minima eh de 10 pessoas  \n\n\n");
    scanf("%d", &quantidade_de_convidados);    while (quantidade_de_convidados<10 || quantidade_de_convidados>500)  //Uso while com teste no inicio para forçar o usuário a digitar um valor valido, como informado no printf anterior    {        printf("\n\n\ Digite uma opcao valida\n\n\ ");        scanf("%d", &quantidade_de_convidados);    }    printf("\n\n\ Opcao armazenada\n\n\ ");
    ...
    printf("%sGostaria de alterar algum dado fornecido? Se sim digite 1, no caso de querer apenas continuar digite 2 ou se querer ver dados ja fornecidos digite 3\n\n",r1.sobrenome_do_cliente);
...
//uso a variavel mudanca_de_dados como parametro junto do while novamente com teste no inicio(para repetir quantas vezes for preciso e se for preciso)para de acordo com oq for digitado pelo usuário o programa apenas mostrar oq tiver sido cadastrado, alterar oq foi cadastrado ou não fazer nada
...
            printf("\n\n\nMODIFICANDO CADASTRO \n\n\n");            fgets (r1.nome_do_cliente,50,stdin);// usei esse fgets apenas porque na hora de compilar estava pulando para a próxima pergunta direto sem receber a resposta da anterior            printf("\n\n\nDigite o seu nome para cadastramento: \n\n\n");            fgets (r1.nome_do_cliente,50,stdin);
    ...
    if (quantidade_de_convidados<=50 && publico_festa==1 && tipo_de_festa_total==1) //Uso novamente if como operador lógico e o swith como estrutura para executar o bloco de comandos em relação ao tipo d pagamento
        ...
        {
        case 1:            pvalor_total11=desconto_por(pvalor_total11); //Fiz uso de operação aritmética simples usando os valores digitados pelo usuário para as variáveis  para calcular o valor total com desconto
            printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",pvalor_total11);
            break;

        case 2:
            printf("\n\n\  valor total a ser pago se fosse a vista: %.2f \n\n\ ",pvalor_total11);
            break;
    ...
    else
    {
        if (quantidade_de_convidados<=50 && publico_festa==1 && tipo_de_festa_total==2)
            ...
            {
            case 1:
                pvalor_total12=desconto_por(pvalor_total12); //Fiz uso de operação aritmética simples para calcular o valor total com desconto
                printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",pvalor_total12);
                break;
        ...
        else
        {
            if (quantidade_de_convidados<=50 && publico_festa==1 && tipo_de_festa_total==3)
                ...
                {
                case 1:
                      pvalor_total13=desconto_por(pvalor_total13); //Fiz uso de operação aritmética simples para calcular o valor total com desconto
                    printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",pvalor_total13);
                    break;
            ...
            else
            {
                if (quantidade_de_convidados<=50 && publico_festa==2 && tipo_de_festa_total==1)
                    ...
                    {
                    case 1:
                        pvalor_total21=desconto_por(pvalor_total21); //Fiz uso de operação aritmética simples para calcular o valor total com desconto
                        printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",pvalor_total21);
                        break;
                ...
                else
                {
                    if  (quantidade_de_convidados<=50 && publico_festa==2 && tipo_de_festa_total==2)
                        ...
                        {
                        case 1:
                            pvalor_total22=desconto_por(pvalor_total22); //Fiz uso de operação aritmética simples para calcular o valor total com desconto
                            printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",pvalor_total22);
                            break;
                    ...
                    else
                    {
                        if (quantidade_de_convidados<=50 && publico_festa==2 && tipo_de_festa_total==3)
                            ...
                            {
                            case 1:
                               pvalor_total23=desconto_por(pvalor_total23); //Fiz uso de operação aritmética simples para calcular o valor total com desconto
                                printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",pvalor_total23);
                                break;
                        ...
                        else
                        {
                            if (quantidade_de_convidados>50&&quantidade_de_convidados<=100 && publico_festa==1 && tipo_de_festa_total==1)
                                ...
                                {
                                case 1:
                                   mvalor_total11=desconto_por(mvalor_total11); //Fiz uso de operação aritmética simples para calcular o valor total com desconto
                                    printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",mvalor_total11);
                                    break;
                            ...
                            else
                            {
                                if (quantidade_de_convidados>50&&quantidade_de_convidados<=100 && publico_festa==1 && tipo_de_festa_total==2)
                                    ...
                                    {
                                    case 1:
                                         mvalor_total12=desconto_por(mvalor_total12); //Fiz uso de operação aritmética simples para calcular o valor total com desconto
                                        printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f\n\n\ ",mvalor_total12);
                                        break;
                                ...
                                else
                                {
                                    if (quantidade_de_convidados>100&&quantidade_de_convidados<=500 && publico_festa==1 && tipo_de_festa_total==3)
                                        ...
                                        {
                                        case 1:
                                            mvalor_total13=desconto_por(mvalor_total13); //Fiz uso de operação aritmética simples para calcular o valor total com desconto
                                            printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",mvalor_total12);
                                            break;
                                    ...
                                    else
                                    {
                                        if (quantidade_de_convidados>100&&quantidade_de_convidados<=500 && publico_festa==2 && tipo_de_festa_total==1)
                                            ...
                                            {
                                            case 1:
                                                mvalor_total21=desconto_por(mvalor_total21); mvalor_total21=mvalor_total21-desconto_a_vista/100*mvalor_total21; //Fiz uso de operação aritmética simples para calcular o valor total com desconto
                                                printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",mvalor_total21);
                                                break;
                                        ...
                                        else
                                        {
                                            if (quantidade_de_convidados>100&&quantidade_de_convidados<=500 && publico_festa==2 && tipo_de_festa_total==2)
                                                ...
                                                {
                                                case 1:
                                                    mvalor_total22=desconto_por(mvalor_total22); //Fiz uso de operação aritmética simples para calcular o valor total com desconto
                                                    printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",mvalor_total22);
                                                    break;
                                            ...
                                            else
                                            {
                                                if (quantidade_de_convidados>100&&quantidade_de_convidados<=500 && publico_festa==2 && tipo_de_festa_total==3)
                                                    ...
                                                    {
                                                    case 1:
                                                        mvalor_total23=desconto_por(mvalor_total23); //Fiz uso de operação aritmética simples para calcular o valor total com desconto
                                                        printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",mvalor_total23);
                                                        break;
                                                ...
                                                else
                                                {
                                                    if (quantidade_de_convidados>100&&quantidade_de_convidados<=500 && publico_festa==1 && tipo_de_festa_total==1)
                                                        ...
                                                        {
                                                        case 1:
                                                             gvalor_total11=desconto_por(gvalor_total11); //Fiz uso de operação aritmética simples para calcular o valor total com desconto
                                                            printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",gvalor_total11);
                                                            break;
                                                    ...
                                                    else
                                                    {
                                                        if (quantidade_de_convidados>100&&quantidade_de_convidados<=500 && publico_festa==1 && tipo_de_festa_total==2)
                                                            ...
                                                            {
                                                            case 1:
                                                                gvalor_total12=desconto_por(gvalor_total12); //Fiz uso de operação aritmética simples para calcular o valor total com desconto
                                                                printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",gvalor_total12);
                                                                break;
                                                        ...
                                                        else
                                                        {
                                                            if (quantidade_de_convidados>100&&quantidade_de_convidados<=500 && publico_festa==1 && tipo_de_festa_total==3)
                                                                ...
                                                                {
                                                                case 1:
                                                                    gvalor_total13=desconto_por(gvalor_total13); //Fiz uso de operação aritmética simples para calcular o valor total com desconto
                                                                    printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",gvalor_total13);
                                                                    break;
                                                            ...
                                                            else
                                                            {
                                                                if (quantidade_de_convidados>100&&quantidade_de_convidados<=500 && publico_festa==2 && tipo_de_festa_total==1)
                                                                    ...
                                                                    {
                                                                    case 1:
                                                                        gvalor_total21=desconto_por(gvalor_total21); //Fiz uso de operação aritmética simples para calcular o valor total com desconto
                                                                        printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",gvalor_total21);
                                                                        break;
                                                                ...
                                                                else
                                                                {
                                                                    if (quantidade_de_convidados>100&&quantidade_de_convidados<=500 && publico_festa==2 && tipo_de_festa_total==2)
                                                                        ...
                                                                        {
                                                                        case 1:
                                                                            gvalor_total22=desconto_por(gvalor_total22);//Fiz uso de operação aritmética simples para calcular o valor total com desconto
                                                                            printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",gvalor_total22);
                                                                            break;
                                                                    ...
                                                                    else
                                                                    {
                                                                        if (quantidade_de_convidados>100&&quantidade_de_convidados<=500 && publico_festa==2 && tipo_de_festa_total==3)
                                                                            ...
                                                                            {
                                                                            case 1:
                                                                             gvalor_total23=desconto_por(gvalor_total23);//Fiz uso de operação aritmética simples para calcular o valor total com desconto
                                                                                printf("\n\n\ valor com desconto por ser a pagamento a vista eh: %.2f \n\n\ ",gvalor_total23);
                                                                                break;
